<script lang="ts">
  ...
  function ankiButtonIcon(result: DictResult, resultIndex: number): string {
    ...
    if (ankiActionState === "added" || ankiActionState === "duplicate") return "✓";
...
<style>
  ...
  .lookup-expression-wrap { display: flex; align-items: baseline; flex-wrap: wrap; gap: 4px 8px; min-width: 0; color: #fff; line-height: 1.25; overflow-wrap: anywhere; }
  ...
  .lookup-action-slot { display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; padding: 0; background: transparent; color: #d7d9dc; border: 0; border-radius: 14px; cursor: pointer; font-size: 16px; line-height: 1; user-select: none; }
  .lookup-action-slot:disabled { color: #7f858c; cursor: not-allowed; opacity: 0.5; }
  ...
  .frequency-values { min-width: 0; padding: 4px; color: #d7d9dc; overflow-wrap: anywhere; }
  .pitch-list { display: flex; flex-direction: column; gap: 5px; margin-top: 2px; color: #d7d9dc; font-size: 12px; line-height: 1.35; }
  ...
  .transcription-entries { color: #b7bcc3; }
  .pitch-visual { display: inline-flex; align-items: flex-end; margin-right: 4px; vertical-align: bottom; }
  .pronunciation-mora { position: relative; display: inline-flex; flex-direction: column; align-items: center; min-width: 1.05em; padding-top: 6px; color: #d7d9dc; font-size: 12px; line-height: 1.1; }
  .pronunciation-mora-line { position: absolute; top: 2px; left: 0; right: 0; height: 1px; background: transparent; }
  .pronunciation-mora[data-pitch="high"] .pronunciation-mora-line { background: #cdd5df; }
  ...
  .pitch-position { color: #b7bcc3; font-size: 11px; }
  ...
  .anki-preview { display: flex; flex-direction: column; gap: 4px; padding: 6px 8px; background: #202326; border: 1px solid #3c4043; border-radius: 4px; }
