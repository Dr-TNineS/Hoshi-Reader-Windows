...
3. Follow the complete Anki/audio route in `docs/ANKI_AUDIO_SYNC_PLAN.md`.
   - Current: Slice 5G, stable multi-source remote audio management and ordered fallback.
   - Next: Slice 5H, shared word-audio resolver, bounded preview cache, and popup playback.
   - Slices 5A-5F are complete at their documented validation levels. Do not promote automated results to real runtime verification.
