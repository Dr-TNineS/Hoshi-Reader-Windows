...
3. Next recommended product area: Anki media export Slice 4C from `docs/ANKI_MEDIA_EXPORT_PLAN.md`, which integrates stored dictionary media into add-note flow while preserving duplicate handling.
