...
3. Next recommended product area: Anki media export Slice 4B from `docs/ANKI_MEDIA_EXPORT_PLAN.md`, which adds Rust/AnkiConnect `storeMediaFile` support without creating notes.
